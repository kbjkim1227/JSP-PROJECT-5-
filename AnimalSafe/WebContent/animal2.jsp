...
<jsp:include page="fragment/header.jsp" flush="false"/>    
	<div style="width:100%;height:100px;">
      <section class ="content">
        <ul class="first_icon">
          <li>&nbsp;<input class="button" id="animal1" type="button" value="네로" onclick="
              if(document.querySelector('#animal1').value === '네로'){
          ...
          <li>&nbsp;<input class="button" id="animal2" type="button" value="나비" onclick="
            if(document.querySelector('#animal2').value === '나비'){
                  document.querySelector('#animal_2').style.display='block';
                document.querySelector('#animal_1').style.display='none';
                document.querySelector('#animal_3').style.display='none';
            }
          " style ="width: 200px ; height:50px; font-size:15px;"></li>
          <li>&nbsp;<input class="button" id="animal3" type="button" value="방울" onclick="
            if(document.querySelector('#animal3').value === '방울'){
