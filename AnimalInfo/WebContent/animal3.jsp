...
<jsp:include page="fragment/header.jsp" flush="false"/>    
	<div style="width:100%;height:100px;">
      <section class ="content">
        <ul class="first_icon">
           <li>&nbsp;<input class="button" id="animal1" type="button" value="코코" onclick="
              if(document.querySelector('#animal1').value === '코코'){
          ...
          <li>&nbsp;<input class="button" id="animal2" type="button" value="디디" onclick="
            if(document.querySelector('#animal2').value === '디디'){
          ...
          <li>&nbsp;<input class="button" id="animal3" type="button" value="파파" onclick="
            if(document.querySelector('#animal3').value === '파파'){
